...
|---|---|---|---|---|
| 📝 **Personal Blog** | Technical journey, project write-ups, and ideas. | ![TypeScript](https://img.shields.io/badge/-TypeScript-3178C6?style=flat-square&logo=typescript&logoColor=white) | [Visit](https://abedini.me) | [Repo](https://github.com/Ali-hey-0/blog) |
| 🏭 **Arka Industrial** | Industrial e-commerce platform — staging, moving to production soon. | ![Web](https://img.shields.io/badge/-Web_App-FF5722?style=flat-square) | [Staging](https://staging.arka-industrial.com) | 🔒 Private |
...
| 🐹 **Go_Explain** | Practical Go tutorial covering concurrency, idiomatic patterns, and fundamentals — includes a Persian (فارسی) README. | ![Go](https://img.shields.io/badge/-Go-00ADD8?style=flat-square&logo=go&logoColor=white) | [Repo](https://github.com/Ali-hey-0/Go-Explain) |
...
> ⚠️ **Lab-safe & educational.** These repositories are part of my ongoing self-study in offensive security and penetration testing — built and run in isolated lab environments. None of this is for malicious use.

| Project | Description | Link |
|---|---|---|
| 🕸️ **Aion** | Botnet/C2 simulation demonstrating offensive-security techniques in Python (lab-safe). | [Repo](https://github.com/Ali-hey-0/Aion) |
| 🌐 **Hacking-Tools** | Network-security documentation, write-ups, and tooling. | [Repo](https://github.com/Ali-hey-0/Hacking-Tools) |
| 🛡️ **owasp** | OWASP-based security training & penetration-testing lab. | [Repo](https://github.com/Ali-hey-0/owasp) |
| 🐉 **Kali-Tools** | Curated all-in-one collection of pentesting tools. | [Repo](https://github.com/Ali-hey-0/Kali-Tools) |
...
| 🔑 **NatasPasswordCracker** | Walkthrough/solver for the Natas web-security wargame. | [Repo](https://github.com/Ali-hey-0/NatasPasswordCracker) |
| 📡 **Ddos-tutorial** | Educational guide on DDoS attack-method classification and analysis. | [Repo](https://github.com/Ali-hey-0/Ddos-tutorial) |
| 🔎 **OSINT** | All-in-one OSINT reconnaissance tool for website analysis. | [Repo](https://github.com/Ali-hey-0/OSINT) |
| 🕵️ **browser-fingerprint-collector** | Research tool exploring browser fingerprinting techniques. | [Repo](https://github.com/Ali-hey-0/browser-fingerprint-collector) |
| 🖥️ **javaScript_Security** | Client-side device/browser data collection tool for studying browser attack surfaces and client-side OSINT (consent-only use). | [Repo](https://github.com/Ali-hey-0/javaScript_Security) |
| 🧬 **Ransomware.Jigsaw** | Educational analysis/recreation of the Jigsaw ransomware for malware research. | [Repo](https://github.com/Ali-hey-0/Ransomware.Jigsaw) |
| 📥 **config-scrapper-** | Telegram channel config scraper for OSINT/data-collection research. | [Repo](https://github.com/Ali-hey-0/config-scrapper-) |
...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20,24,25&height=150&section=footer&text=Thanks%20for%20Visiting!&fontSize=35&fontColor=fff&animation=fadeIn" />
